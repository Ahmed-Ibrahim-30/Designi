...
#include "View/JsonExtraction.h"
#include "Model/Polygon.h"
#include "Model/DesignWallGenerator.h"
#include "Model/DesignGeometryManager.h"
#include "Model/Land/Land.h"
#include "Model/PolygonLibrary/PolygonsSubtraction.h"
#include "Model/Land/Green Area/UniformGreenDistributor.h"
#include "Model/Land/Green Area/ClusteredGreenSelector.h"

HomeDesignController::HomeDesignController(QQmlApplicationEngine *engine)
{
    mEngine = engine;
...
void HomeDesignController::designProcess()
{
    ...
    QMLWallView * wallsResult = new QMLWallView(mEngine);
    wallsResult->setWalls(walls);
...
//    designResultView = new ConsoleResultView();
    designResultView = new QMLResultView(mEngine);
